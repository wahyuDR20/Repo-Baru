                ...
                <form action="<?php echo site_url('user_management/user/register') ?>" method="post">
                    ...
                    <div class="form-row col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama" placeholder="Nama" name="nama" value="<?php echo $userdata['nama'];?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="no_telp">Nomor Telepon</label>
                            <input type="text" class="form-control" id="no_telp" placeholder="Nomor Telepon" name="no_telp" value="<?php echo $userdata['no_telepon'];?>">
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" id="alamat" placeholder="Alamat" name="alamat" ><?php echo $userdata['alamat'];?></textarea>
                    </div>
                    <div class="form-row col-md-12">
                        <div class="form-group col-md-6">
                            <label for="email">Email</label>
                            <input type="text" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $userdata['email'];?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="username">Username</label>
                            <input type="text" class="form-control" id="username" placeholder="Username" name="username" value="<?php echo $userdata['username'];?>">
                        </div>
                    </div>
                    <div class="form-row col-md-12">
                        <div class="form-group col-md-6">
